...
module.exports = {
    ...
    handler: async (req, res) => {
      try {
        ...
        const notifications = await Notification.findAll({
          ...
          attributes: ['id', 'user_id', 'diagram_id', 'type', 'message', 'read', 'created_at'],
  ...
  getDiagrams: {
    handler: async (req, res) => {
      try {
        ...
        const uniqueDiagrams = [...new Map(diagrams.map(notification => [notification.diagram.id, notification.diagram])).values()];
  ...
  create: {
    handler: async (req, res) => {
      try {
        const { user_id, diagram_id, type, message } = req.body;
